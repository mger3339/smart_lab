...
|
*/
$config['encryption_key'] = '7A4cn7dng3d8Qy07G3TYgMR602m6bX3P';
...
$config['sess_cookie_name'] = 'smartlab_session';
...
$config['csrf_token_name'] = 'smartlab_csrf_token';
$config['csrf_cookie_name'] = 'smartlab_csrf_cookie';
...
if ( ! function_exists('__autoload'))
{
	function __autoload($class)
	{
		...
		{
			$context_class = APPPATH . 'contexts/'. $class . '.php';
			$model_class = APPPATH . 'models/'. $class . '.php';
			
			if ( file_exists($context_class) )
			{
				$class = $context_class;
			}
