...
class Migration_client_snapshot_session_groups extends CI_Migration {
    ...
    /**
     * Add client client_snapshot_session_groups table
     *
     */
    public function up()
    {
    ...
    /**
     * Drop client_snapshot_session_groups table
     *
     */
    public function down()
    {
        echo "\n Dropping client_snapshot_session_groups table";
        $this->dbforge->drop_table('client_snapshot_session_groups', TRUE);
